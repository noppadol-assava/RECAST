...
def allApproachSingleRoleEvaluation(datasetName, outpath):
    ...
    for i in approach:
        if i == 'our':
            path = 'out/output/individualrec/'+i+'/new/output_'+i+'_hitnohit_'+datasetName+'_'
        elif i == 'random' or i == 'dump':
        ...
        outfile = outpath+datasetName+'/'+i+'/'+'eval_individual_singleRole_'+i+'_'+datasetName+'.txt'
...
allApproachSingleRoleEvaluation('moodle', 'result/individualrec/')
